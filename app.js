const DEFAULT_CARDS=[
 ...
 {id:'public-safety',term:'public safety',meaning:'seguridad pública',pronunciation:'páblik-séifti',example:'This is important for public safety.',translation:'Esto es importante para la seguridad pública.',remember:'Safety significa seguridad o ausencia de peligro.',cloze:'This is important for public ___.',distractors:['safe','secure','health']}
  ...
  ,{id:'hows-your-class',term:"How's your class?",meaning:'¿Qué tal tu clase?',pronunciation:'jáuz-yor-klás',example:"How's your class? It's interesting.",translation:'¿Qué tal tu clase? Es interesante.',remember:"How's es la contracción de how is. Se usa aquí porque class está en singular.",cloze:'___ your class?',distractors:['How are','How do','How am']}
  ,{id:'how-are-your-classes',term:'How are your classes?',meaning:'¿Qué tal tus clases?',pronunciation:'jáu-ar-yor-klá-siz',example:'How are your classes? They are difficult but interesting.',translation:'¿Qué tal tus clases? Son difíciles pero interesantes.',remember:'Con classes en plural usamos are: How are your classes?',cloze:'How ___ your classes?',distractors:['is','do','am']}
  ,{id:'response-shes-good',term:"She's good.",meaning:'Ella está bien / Es buena.',pronunciation:'shíiz-gud',example:"How's your teacher? She's good.",translation:'¿Qué tal tu profesora? Está bien.',remember:"She's es la contracción de she is. Se usa para una mujer.",cloze:"How's your teacher? She's ___.",distractors:['great','OK','so-so']}
  ,{id:'response-theyre-great',term:"They're great!",meaning:'¡Son geniales! / ¡Están muy bien!',pronunciation:'der-gréit',example:"How are your classes? They're great!",translation:'¿Qué tal tus clases? ¡Son geniales!',remember:"They're es la contracción de they are. Se usa aquí porque classes es plural.",cloze:"How are your classes? They're ___!",distractors:['good','OK','so-so']}
  ,{id:'response-hes-ok',term:"He's OK.",meaning:'Él está bien / Está más o menos.',pronunciation:'jíiz-ou-kéi',example:"How's your teacher? He's OK.",translation:'¿Qué tal tu profesor? Está bien.',remember:"He's es la contracción de he is. OK es una respuesta neutral: ni excelente ni mala.",cloze:"How's your teacher? He's ___.",distractors:['good','great','so-so']}
  ,{id:'response-theyre-so-so',term:"They're so-so.",meaning:'Están más o menos.',pronunciation:'der-sóu-sóu',example:"How are your classes? They're so-so.",translation:'¿Qué tal tus clases? Están más o menos.',remember:'So-so es una respuesta neutral e informal: más o menos, ni bien ni mal.',cloze:"How are your classes? They're ___.",distractors:['good','great','OK']}
];
